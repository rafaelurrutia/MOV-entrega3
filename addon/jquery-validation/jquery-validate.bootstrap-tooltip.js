		...
		prototype:{
			defaultShowErrors: function() {
				...
				$.each( this.errorList, function(index, value) {
					$(value.element).removeClass(self.settings.validClass).addClass(self.settings.errorClass).popover('destroy').popover(self.apply_tooltip_options(value.element,value.message)).popover('show'); 
					$( "<button type='button' class='close' data-dismiss='popover' aria-label='Close'><span aria-hidden='true'>&times;</span></button>" ).insertAfter( ".popover-title" );
